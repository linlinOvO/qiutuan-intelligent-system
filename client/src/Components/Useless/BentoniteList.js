                ...
                <table>
                    ...
                    {materials.map((material, index) => (
                        <tr key={index}>
                            ...
                            <td>{material.F.toFixed(3)}</td>
                            <td>{material.P.toFixed(3)}</td>
                            <td>{material.water.toFixed(3)}</td>
                            <td>{material.burningLoss.toFixed(3)}</td>
                            <td>{material.colloidIndex.toFixed(3)}</td>
                            <td>{material.blueAbsorption.toFixed(3)}</td>
                            <td>{material.montmorilloniteContent.toFixed(3)}</td>
                            <td>{material.expansionCapacity.toFixed(3)}</td>
