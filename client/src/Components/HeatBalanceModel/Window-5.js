...
import '../../App.css'
import {getPart1, getPart2, getPart3, getPart4, getPart5} from "./Parameters";
...
const Window5 = () => {
    ...
    const Part5 = () => {
        ...
        useEffect(() => {
            setPart(getPart5(part1, part2, part3, part4))
        }, [])
        ...
        return(
            <div className="hb-part2-longBar">
                ...
                <div className="hb-part2-longBar-body">
                    {createPart("物料平衡计算结果", part.slice(0, 30))}
                    {createPart("热平衡计算结果", part.slice(30, 67))}
                    {createPart("技术指标", part.slice(67, 73))}
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="hb-part2">
            <Part1 part={part1} setPart={setPart1}/>
            <Part2 part={part2} setPart={setPart2}/>
            <Part3 part={part3} setPart={setPart3}/>
            <Part4 part={part4} setPart={setPart4}/>
            <Part5/>
        </div>
    )
...
const Part2 = (props) => {
    ...
    return (
        <div className="hb-part2-longBar">
            ...
            <div className="hb-part2-longBar-body">
                {createUnites(part.slice(0, 49))}
                {createPart("生球成分", part.slice(49, 58))}
                {createPart("链篦机出料球成分", part.slice(58, 66))}
                {createPart("预热二段吸风成分", part.slice(66, 68))}
                {createPart("鼓风干燥段烟气成分", part.slice(68, 73))}
                {createPart("抽风干燥段烟气成分", part.slice(73, 78))}
                {createPart("预热一段烟气成分", part.slice(78, 83))}
                {createPart("预热二段烟气成分", part.slice(83, 88))}
            </div>
        </div>
    )
...
const Part3 = (props) => {
    ...
    return (
        <div className="hb-part2-longBar">
            ...
            <div className="hb-part2-longBar-body">
                {createUnites(part.slice(0, 14).concat(part.slice(21, 25)))}
                {createPart("回转窑烟气成分", part.slice(14, 19))}
                {createPart("助燃风成分", part.slice(19, 21))}
            </div>
        </div>
    )
...
const Part4 = (props) => {
    ...
    return (
        <div className="hb-part2-longBar">
            ...
            <div className="hb-part2-longBar-body">
                {createUnites(part.slice(0, 58))}
                {createPart("出料球成分", part.slice(58, 66))}
                {createPart("环冷一段烟气成分", part.slice(66, 71))}
                {createPart("环冷二段烟气成分", part.slice(71, 76))}
                {createPart("鼓风成分", part.slice(76, 78))}
                {createPart("环冷三段烟气成分", part.slice(78, 83))}
                {createPart("环冷四段烟气成分", part.slice(83, 88))}
            </div>
        </div>
    )
